...
def analyze_text_for_scam(text):
    ...
    template = """
        คุณเป็นนักวิเคราะห์และให้คำปรึกษาทางด้านดูแลความปลอดภัยทางไซเบอร์ ของบริษัทประกันไทยวิวัฒน์ วิเคราะห์ข้อความต่อไปนี้เพื่อหาสัญญาณที่อาจเป็นการหลอกลวงเท่านั้น  
